...
function CraftCard({
  ...
  onOpen: (p: CraftProject) => void;
}) {
  const { ref, visible } = useScrollAnimation();
  return (
    <div
      ref={ref}
      className={`craft-card animate-on-scroll${visible ? ' visible' : ''}`}
      onClick={() => onOpen(project)}
    >
      <div className="craft-image-container">
        <img src={project.mainImage} alt={project.title} className="craft-image" />
      </div>
...
const Craft: React.FC = () => {
  ...
  const craftProjects: CraftProject[] = [
    { id: 1, title: 'Minion', description: 'A small minion (Dave) Amigurumi. This was my first amigurumi project!', mainImage: minion1, additionalImages: [minion4, minion6, minion3, minion2, minion5] },
    { id: 2, title: 'Koya', description: "A big Koya (BT21) Amigirumi. I made this for my wife's birthday!!", mainImage: koya1, additionalImages: [koya2, koya3, koya4, koya5, koya6, koya7, koya8, koya9, koya10] },
    { id: 3, title: 'Baby Romper', description: 'A baby romper that I made for my niece! It was just a little too small for her, but when she turned one, she dressed her teddy bear in it instead!', mainImage: babyRomper0, additionalImages: [babyRomper2] },
    { id: 4, title: 'Snoopy', description: 'A big Snoopy Amigurumi that I made for my mom. I made this in about 4 days!', mainImage: snoopy1, additionalImages: [snoopy2, snoopy3, snoopy4, snoopy5, snoopy6] },
    { id: 5, title: 'Vinny', description: 'A cute Amigirumi of a beautiful black cat, Vinny!', mainImage: vinny1, additionalImages: [vinny2, vinny3, vinny4, vinny5] },
    { id: 6, title: 'Lola', description: 'A cute Amigirumi of a beautiful ragdoll cat, Lola!', mainImage: lola1, additionalImages: [lola2, lola3, lola4, lola5, lola6] },
    { id: 7, title: 'Cooky', description: 'A small Cooky (BT21) Amigirumi! I made this one with the Koya Amigurumi', mainImage: cooky1, additionalImages: [cooky2, cooky3, cooky4] },
    { id: 8, title: 'Totoro', description: 'A small Totoro Amigurumi! I plan to make the big, medium and small versions of Totoro soon!', mainImage: totoro1, additionalImages: [totoro2, totoro3, totoro4, totoro5, totoro6, totoro7] },
    { id: 9, title: 'Sheep', description: 'A cute sheep Amigurumi! I learned how to do the popcorn stitch. Not the most fun stitch but it turned out cute!', mainImage: sheep1, additionalImages: [sheep2, sheep3, sheep4, sheep5] },
    { id: 10, title: 'Fox', description: 'A cute fox Amigurumi! I added the acorns!', mainImage: fox1, additionalImages: [fox2] },
    { id: 11, title: 'Alpaca', description: "A cute aplaca Amigirumi. I don't know how this one turned out so ripped!", mainImage: alpaca1, additionalImages: [alpaca2, alpaca3, alpaca4, alpaca5, alpaca6, alpaca7, alpaca8, alpaca9, alpaca10] },
    { id: 12, title: 'Duck', description: 'A cute small duck Amigurumi! This one was easy but one of the cutest Amigurumi', mainImage: duck1, additionalImages: [duck2, duck3, duck4, duck5] },
  ];

  const openProjectDetails = (project: CraftProject) => {
    ...
    <section className="craft-section">
      ...
      <div className="craft-grid">
        {craftProjects.map(project => (
          <CraftCard key={project.id} project={project} onOpen={openProjectDetails} />
        ))}
      </div>
        ...
        <div className="project-modal-overlay" onClick={closeProjectDetails}>
          <div className="project-modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="project-gallery">
              <div className="main-project-image-container">
                <div className="main-project-image">
                  <img src={getCurrentImage()} alt={selectedProject.title} />
                </div>
              </div>
            ...
            <div className="navigation-help">
              <p>Use left/right arrow keys to navigate or click thumbnails</p>
            </div>
          </div>
        </div>
      )}
