...
export const projects: Project[] = [
  {
    ...
    technologies: ['Alexa Skills Kit', 'AWS Lambda', 'DynamoDB', 'Google Calendar API', 'OAuth 2.0', 'Google Apps Script', 'Voice Monkey'],
  ...
  },
  {
    ...
    description:
      'Real-time score-following web app that listens to your microphone as you play and automatically turns the page. Achieved 100% within-±1-measure accuracy using Hidden Markov Models and spectral flux onset detection across all tested tempos.',
    technologies: ['React', 'Vite', 'Python', 'FastAPI', 'HMM', 'librosa', 'Docker', 'AWS App Runner', 'GitHub Actions'],
    repo: 'https://github.com/myasumoto16/SmartMusicSheet',
    demo: '',
    detail: false,
  },
  {
    ...
    technologies: ['Swift', 'SwiftUI', 'WidgetKit', 'AppIntents', 'Keychain', 'iOS 17'],
    repo: 'https://github.com/myasumoto16/PawsApp',
    demo: '',
    detail: false,
  },
  {
    ...
    description:
      'Smart medication bottle with built-in sensors that detects when it\'s opened and sends users text or email notifications. It is also connected with Alexa for voice-based queries.',
    ...
    sections: [
      {
        ...
        images: [{ url: intial_circuit, description: 'Initial Circuit Design' }],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'One small limitation of this setup is that both ESP-NOW and Wi-Fi operate on the same 2.4 GHz frequency and cannot run simultaneously. As a result, after receiving a message from the client, the server must temporarily disable ESP-NOW to connect to Wi-Fi and send the notification.',
        ],
        images: [{ url: second_pro, description: 'Second Prototype with two ESP8266' }],
      },
      {
        title: 'Alexa Integration',
        bullets: [
          'I love using Alexa in my everyday life. It makes getting information simple and convenient through voice commands, without the distractions of other apps on my phone.',
          'To enable this functionality, I created a DynamoDB table to store timestamps whenever the medication bottle is opened. When the server ESP8266 detects the event, it sends a REST API POST request to an AWS API Gateway endpoint. This triggers a Lambda function that records the timestamp in the DynamoDB table.',
          'Building on this foundation, I developed a custom Alexa skill that allows users to ask, "Have I taken my medication today?" When prompted, Alexa queries the DynamoDB table through another Lambda function, checks for the last recorded activity, and checks if the date matches the current date.',
        ],
        images: [
      ...
      },
      {
        ...
        bullets: [
          'The third version of the project involved assembling all components onto a compact perfboard, powered by a CR123A battery. The most challenging part of the build was soldering, which took some practice to get used to.',
          ...
          'Through further research, I discovered that the NodeMCU D1 Mini boards sometimes require two reset signals to fully reboot.',
        ],
        images: [
      ...
      },
      {
        title: 'Next Step',
        bullets: [
          'I plan to experiment with different circuit designs using a normally closed reed switch. In this setup, the reed switch will be placed between the battery and the 3.3V pin of the board.',
          'This design could be more efficient than using deep sleep since, in theory, it should consume no power when the bottle is closed.',
        ],
      },
    ],
    videoDemo: '',
  ...
  },
  {
    ...
    description:
      'Book Recommendation systems utilizing OpenAI and HugginFace models, sentiment analysis, and vector search to categorize and suggest books, featuring an interactive Gradio UI for an enhanced user experience.',
  ...
  },
  {
    ...
    title: 'Moosa 🐾',
    description:
      'React Native video-sharing app for pet lovers, inspired by my cat Moose, allowing users to upload, like, and explore pet videos with secure authentication and cloud storage via Appwrite.',
  ...
  },
  {
    ...
    title: 'Moose or Lola? 🐈',
    description:
      'Image classification system that determines if the given picture is our beloved ragdoll Moose or his identical-looking friend Lola!',
  ...
  },
  {
    ...
    description:
      'Web App that automates web application security assessments, integrates open-source security tools, and manages user authentication and past assessment data via a REST API and MongoDB.',
  ...
  },
  {
    ...
    title: 'MBTA Transit',
    description:
      'Android app that provides real-time updates on Massachusetts transit services by aggregating data from MBTA\'s REST APIs, enhancing accessibility and user experience through object-oriented programming.',
